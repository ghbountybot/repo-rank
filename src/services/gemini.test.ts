...
+}`,
    ...
    test("analyzeCommit returns valid analysis", async () => {
        const analysis = await analyzeCommit(sampleCommit);
    ...
    test("analyzeCommitWithReferences returns valid relative analysis", async () => {
        const analysis = await analyzeCommitWithReferences(sampleCommit, referenceCommits);
    ...
    test("handles commit without patch", async () => {
        ...
        const analysis = await analyzeCommit(commitWithoutPatch);
